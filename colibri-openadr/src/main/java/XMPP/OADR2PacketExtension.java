...
//		return this.payload.getName().getNamespaceURI();
	...
	@Override public String toXML() {
		try {
			...
			// TODO old version xml=xml.replaceFirst("xmlns=\"http://openadr.org/oadr-2.0b/2012/07\"", "xmlns:oadr=\"http://openadr.org/oadr-2.0b/2012/07\"");
			return xml;
			// TODO clean version return sw.toString();
		}
