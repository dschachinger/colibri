 ...
 * This class holds the important information for an oadrUpdatedReport message.
 */
public class MsgInfo_OADRUpdatedReport implements OADRMsgInfo {
    /* A oadrUpdatedReport can contain oadrCancelReport elements optionally. These are used to cancel reports.
       Therefore the MsgInfo_OADRCancelReport is used because it is actually the message to cancel reports.  */
